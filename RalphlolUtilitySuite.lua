...
local lolPatch = (GetGameVersion and GetGameVersion():sub(1,4) == "5.21") and 1 or 2
...
function recallDraw:RecvPacket(p)
	if lolPatch == 1 then
		...
		if p.header == 0x00AE  then --recall
			p.pos = 56
			--local spellid1 = p:Decode1()
			--print("spell "..spellid1)
			local bytes = {}
