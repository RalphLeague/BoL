...
function MachineLib:__init()
	...
	self.lolPatch = GetGameVersion and GetGameVersion():sub(1,4) == "6.19" and 1 or 2
	self.notPresentPatch = GetGameVersion and GetGameVersion():sub(1,4) ~= "6.18" and GetGameVersion():sub(1,4) ~= "6.19"
	self.cn = self.notPresentPatch
	
	--Send--
		self.moveHeader = self.lolPatch == 1 and 120 or 113
		self.spellHeader = self.lolPatch == 1 and 272 or 270
		
		--cspell2
		self.cspell2Header = self.lolPatch == 1 and 377 or 375
		self.cspell2Pos = self.lolPatch == 1 and 23 or 23
		self.cspell2Byte = self.lolPatch == 1 and 0x40 or 0x40
	
	--Rsv--
		self.goldHeader = self.lolPatch == 1 and 341 or 109
		
		--Buy
		self.bHeader = self.lolPatch == 1 and 187 or 0xE1
		...
		--Recall
		self.recallHeader = self.lolPatch == 1 and 259 or 257
