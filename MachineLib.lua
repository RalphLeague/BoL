...
function MachineLib:__init()
	...
	self.lolPatch = GetGameVersion and GetGameVersion():sub(1,4) == "6.16" and 1 or 2
	self.notPresentPatch = GetGameVersion and GetGameVersion():sub(1,4) ~= "6.15" and GetGameVersion():sub(1,4) ~= "6.16"
	self.cn = self.notPresentPatch
	
	--Send--
		self.moveHeader = self.lolPatch == 1 and 113 or 16
		self.spellHeader = self.lolPatch == 1 and 229 or 91
	...
	--Rsv--
		self.goldHeader = self.lolPatch == 1 and 339 or 255
		
		--Buy  Vayne
		self.bHeader = self.lolPatch == 1 and 135 or 131
		...
		--Recall
		self.recallHeader = self.lolPatch == 1 and 48 or 72
