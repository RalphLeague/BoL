...
function MachineLib:__init()
	...
	self.lolPatch = GetGameVersion and GetGameVersion():sub(1,4) == "6.12" and 1 or 2
	self.notPresentPatch = GetGameVersion and GetGameVersion():sub(1,4) ~= "6.11" and GetGameVersion():sub(1,4) ~= "6.12"
	self.cn = self.notPresentPatch
	
	--Send--
		self.moveHeader = self.lolPatch == 1 and 284 or 17
		self.spellHeader = self.lolPatch == 1 and 290 or 286
		
		--cspell2
		self.cspell2Header = self.lolPatch == 1 and 273 or 269
		self.cspell2Pos = self.lolPatch == 1 and 23 or 10
		self.cspell2Byte = self.lolPatch == 1 and 0x40 or 0x60
