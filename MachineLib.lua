...
function MachineLib:__init()
	...
	self.lolPatch = GetGameVersion and GetGameVersion():sub(1,4) == "6.23" and 1 or 2
	self.notPresentPatch = GetGameVersion and GetGameVersion():sub(1,4) ~= "6.22" and GetGameVersion():sub(1,4) ~= "6.23"
	self.cn = self.notPresentPatch
	
	--Send--
		self.moveHeader = self.lolPatch == 1 and 81 or 268
		self.spellHeader = self.lolPatch == 1 and 365 or 118
		
		--cspell2
		self.cspell2Header = self.lolPatch == 1 and 229 or 231
		self.cspell2Pos = self.lolPatch == 1 and 11 or 11
		self.cspell2Byte = self.lolPatch == 1 and 0x40 or 0x40
	
	--Rsv--
		self.goldHeader = self.lolPatch == 1 and 101 or 332
		
		--Buy
		self.bHeader = self.lolPatch == 1 and 0x175 or 0x175
		self.bPos = self.lolPatch == 1 and 14 or 14
		self.botrk = self.lolPatch == 1 and 98 or 98
		self.IE = self.lolPatch == 1 and 202 or 202
		self.Trinity = self.lolPatch == 1 and 249 or 249
	
		--Recall
		self.recallHeader = self.lolPatch == 1 and 167 or 129
