...
function MachineLib:__init()
	...
	--Send--
		...
		--cspell2
		self.cspell2Header = self.lolPatch == 1 and 294 or 304
		self.cspell2Pos = self.lolPatch == 1 and 23 or 23
		self.cspell2Byte = self.lolPatch == 1 and 0x40 or 0x40
	
	--Rsv--
		self.goldHeader = self.lolPatch == 1 and 169 or 135
		
		--Buy  Vayne
		self.bHeader = self.lolPatch == 1 and 16 or 192
		...
		--Recall
		self.recallHeader = self.lolPatch == 1 and 259 or 72
