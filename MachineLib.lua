...
function MachineLib:__init()
	...
	self.lolPatch = GetGameVersion and GetGameVersion():sub(1,4) == "6.22" and 1 or 2
	self.notPresentPatch = GetGameVersion and GetGameVersion():sub(1,4) ~= "6.21" and GetGameVersion():sub(1,4) ~= "6.22"
	self.cn = self.notPresentPatch
	
	--Send--
		self.moveHeader = self.lolPatch == 1 and 268 or 16
		self.spellHeader = self.lolPatch == 1 and 118 or 246
		
		--cspell2
		self.cspell2Header = self.lolPatch == 1 and 231 or 363
		self.cspell2Pos = self.lolPatch == 1 and 11 or 11
		self.cspell2Byte = self.lolPatch == 1 and 0x40 or 0x40
	
	--Rsv--
		self.goldHeader = self.lolPatch == 1 and 332 or 166
		
		--Buy
		self.bHeader = self.lolPatch == 1 and 0x175 or 369
		self.bPos = self.lolPatch == 1 and 14 or 13
		self.botrk = self.lolPatch == 1 and 98 or 98
		self.IE = self.lolPatch == 1 and 202 or 202
		self.Trinity = self.lolPatch == 1 and 249 or 249
	
		--Recall
		self.recallHeader = self.lolPatch == 1 and 129 or 101
