...
function MachineLib:__init()
	...
	self.lolPatch = GetGameVersion and GetGameVersion():sub(1,4) == "6.15" and 1 or 2
	self.notPresentPatch = GetGameVersion and GetGameVersion():sub(1,4) ~= "6.14" and GetGameVersion():sub(1,4) ~= "6.15"
	self.cn = self.notPresentPatch
	
	--Send--
		self.moveHeader = self.lolPatch == 1 and 16 or 278
		self.spellHeader = self.lolPatch == 1 and 91 or 90
		
		--cspell2
		self.cspell2Header = self.lolPatch == 1 and 79 or 294
		self.cspell2Pos = self.lolPatch == 1 and 23 or 23
		self.cspell2Byte = self.lolPatch == 1 and 0x40 or 0x40
	
	--Rsv--
		self.goldHeader = self.lolPatch == 1 and 255 or 169
		
		--Buy  Vayne
		self.bHeader = self.lolPatch == 1 and 131 or 16
		...
		--Recall
		self.recallHeader = self.lolPatch == 1 and 72 or 259
